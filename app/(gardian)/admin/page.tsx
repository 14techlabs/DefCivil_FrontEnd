          ...
          <div className="flex gap-2">
            {(
              ...
              <button
                ...
                className={`px-4 py-2.5 rounded-lg text-[11px] font-black uppercase tracking-mono-tight transition-all ${filtroTipo === opt.id
          ...
          {CARGO_TABS.map((tab) => {
            ...
            return (
              ...
              >
                {tab.label}
                <span
                  className={`ml-1 tabular-nums ${filtroCargo === tab.id ? "text-white/80" : "text-slate-400"
                    }`}
                >
                  ({count})
                </span>
