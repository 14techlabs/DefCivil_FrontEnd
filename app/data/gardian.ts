...
const WEATHER = {
  ...
  condition: "Tempo Bom",
  climateConditions: ["Tempo bom", "Alta umidade", "Chance de chuva baixa"],
  temp: 28,
  feels: 29,
  precipitation: 18,
  rainfall_3h: 1.2,
  ...
  satellite: "GOES-16",
  forecast: [
    { day: "Amanhã", icon: "sunny", high: 29, low: 22, label: "Tempo Bom", color: "secondary" },
    { day: "Quarta", icon: "partly_cloudy_day", high: 28, low: 21, label: "Parc. Nublado", color: "secondary" },
    { day: "Quinta", icon: "sunny", high: 30, low: 22, label: "Ensolarado", color: "secondary" },
    { day: "Sexta", icon: "partly_cloudy_day", high: 27, low: 21, label: "Alta Umidade", color: "warning" },
    { day: "Sábado", icon: "sunny", high: 29, low: 23, label: "Tempo Bom", color: "secondary" },
  ],
  hourly: [
    { h: "15h", mm: 12, temp: 19 },
    { h: "16h", mm: 18, temp: 18 },
  ...
  weeklyPrecipitation: [
    { day: "Seg", pct: 15, level: "low" as const },
    { day: "Ter", pct: 12, level: "low" as const },
    { day: "Qua", pct: 18, level: "low" as const },
    { day: "Qui", pct: 22, level: "low" as const },
    { day: "Sex", pct: 10, level: "low" as const },
    { day: "Sáb", pct: 8, level: "low" as const },
    { day: "Dom", pct: 14, level: "low" as const },
  ],
};
